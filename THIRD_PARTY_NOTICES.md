...
| `bpmn-font` npm package | SIL Open Font License 1.1; full license is shipped in the installed package's `LICENSE` file. | Public [`bpmn-io/bpmn-font`](https://github.com/bpmn-io/bpmn-font) package, separately installed. |
