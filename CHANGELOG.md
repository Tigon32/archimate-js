...
* `FEAT`: add the EE-M10 reviewed relationship chooser for existing
  connect/reconnect gestures: unambiguous defaults, accessible multi-choice
  direction-aware selection, and explicit disallowed/unsupported feedback.
  The reviewed profile remains 23 rows and does not claim full ArchiMate
  conformance; broader profile coverage remains #102. Quick-create remains a
  follow-up slice of EE-M10.
