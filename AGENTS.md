...
- Create agent worktrees only under the sibling `archimate-js-worktrees/<harness>/<issue>-<slug>` root and remove them when your lease ends ([ADR-0013](docs/adr/0013-worktree-location-and-lifecycle.md)).
