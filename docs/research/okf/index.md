...
# ArchiMate public references

* [ArchiModel web application](archimodel-app.md) - Browser tool reference for local ArchiMate Model Exchange File viewing.
* [Archi resources](archi-resources.md) - Official Archi project resource directory.
* [Archi plug-ins](archi-plugins.md) - Official catalog of optional Archi extensions.
* [Visual Paradigm ArchiMate examples](visual-paradigm-examples.md) - Third-party learning examples and patterns.
