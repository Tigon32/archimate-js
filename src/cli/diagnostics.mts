...
export const SAFE_MESSAGES = Object.freeze({
  ...
  BATCH_PARTIAL_FAILURE: 'One or more views could not be exported. See the local manifest for outcomes.',
  ...
  DIFF_INPUT_INVALID: 'One or both model files could not be imported.',
  DIFF_INPUT_INELIGIBLE: 'One or both models are outside the supported lossless DTO subset.',
  DIFF_COMPARISON_FAILED: 'The model comparison could not be completed.',
